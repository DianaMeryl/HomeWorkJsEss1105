'use strict'
  ...
  /*
        Завдання:
        Додайте у форму кнопки "Очистити форму" і "Видалити".
        Під час натискання на кнопку "Очистити форму" всі поля введення форми очищаються (розгляньте використання кнопки reset).
        Під час натискання на кнопку "Видалити" вибраний елемент видаляється зі списку, а форма очищується.
        */
        ...
        deleteButton.addEventListener("click", function () {
            ...
            let delIndex = del.dataset.index;

            listService.listElement.children[delIndex].remove(); 
